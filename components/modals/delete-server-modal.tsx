        ...
        <div className="p-6">
          <DialogHeader className="space-y-3 mb-6">
            ...
            <DialogDescription className="text-center text-slate-600 dark:text-slate-400">
              Bạn có chắc muốn xóa <span className="font-semibold text-red-500">{server?.name}</span>?
              <br />
              <span className="text-xs text-red-400">Server sẽ bị xóa vĩnh viễn.</span>
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
